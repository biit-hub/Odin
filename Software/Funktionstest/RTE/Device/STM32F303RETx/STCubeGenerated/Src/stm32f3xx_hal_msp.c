...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PB1     ------> ADC3_IN1
    */
    GPIO_InitStruct.Pin = ADC3_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC3_1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN2
    */
    HAL_GPIO_DeInit(GPIOA, ADC1_1_Pin|ADC1_2_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB1     ------> ADC3_IN1
    */
    HAL_GPIO_DeInit(ADC3_1_GPIO_Port, ADC3_1_Pin);
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspInit 0 */
    ...
    PA4     ------> DAC1_OUT1
    */
    GPIO_InitStruct.Pin = DAC1_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DAC1_1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA4     ------> DAC1_OUT1
    */
    HAL_GPIO_DeInit(DAC1_1_GPIO_Port, DAC1_1_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = SPI_NSS_Pin|SPI_SCK_Pin|SPI_MISO_Pin|SPI_MOSI_Pin;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, SPI_NSS_Pin|SPI_SCK_Pin|SPI_MISO_Pin|SPI_MOSI_Pin);
